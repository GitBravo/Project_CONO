...
public class NaviLogActivity extends AppCompatActivity {
    ...
    protected void DynamicTableRowInsert(String date, String designer, String type, String paymentMethod, String paymentAmount) {
